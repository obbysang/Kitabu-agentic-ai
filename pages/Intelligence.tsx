            ...
            <div className="bg-slate-50 p-8 rounded-3xl border border-slate-200 relative overflow-hidden group">
                ...
                <div className="bg-white p-4 rounded-xl shadow-sm border border-slate-200 relative z-10">
                    <div className="flex justify-between items-center mb-2 border-b border-slate-100 pb-2">
                        ...
                        <span className="text-xs text-green-500 flex items-center gap-1"><span className="w-1.5 h-1.5 bg-green-500 rounded-full animate-pulse"></span> Connected</span>
                    </div>
                    <div className="space-y-2 font-mono text-xs text-slate-700">
                        <div className="flex justify-between">
                            <span>CRO/USD</span>
                            <span className="font-bold">$0.0845</span>
                        </div>
                        <div className="flex justify-between">
                            <span>VVS APY</span>
            ...
            <div className="bg-slate-50 p-8 rounded-3xl border border-slate-200 relative overflow-hidden">
                ...
                <div className="mt-8 relative z-10">
                    <div className="flex justify-between text-sm font-medium mb-2">
                        ...
                        <span className="text-slate-900">$3,240 / $5,000</span>
                    </div>
                    <div className="w-full bg-slate-200 rounded-full h-4 overflow-hidden">
                        <div className="bg-blue-600 h-full rounded-full" style={{width: '65%'}}></div>
                    </div>
                    <div className="mt-2 text-xs text-gray-400">Resets in 04:32:12</div>
                </div>
            </div>
                     ...
                     <div className="flex items-start gap-3">
                         ...
                         <div>
                             <p className="text-sm text-gray-200 mb-3">
                                 I found <strong>10,000 USDC</strong> sitting idle. Moving this to VVS Finance could earn <strong>$100/mo</strong>.
                             </p>
