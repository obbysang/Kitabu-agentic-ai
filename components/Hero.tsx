  ...
  return (
    <section className="relative w-full h-[110vh] overflow-hidden bg-black text-white">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 h-full flex flex-col justify-center items-center text-center pt-20">
        ...
        {/* Main Headline */}
        <h1 className="text-5xl md:text-7xl lg:text-8xl font-medium tracking-tight leading-[1.1] mb-8 max-w-5xl mx-auto">
          The <span className="text-blue-500">AI CFO</span> for your<br />
          <span className="text-white">On-Chain Treasury</span>
        </h1>

        {/* Description */}
        <p className="max-w-xl text-gray-300 text-lg mb-10 leading-relaxed text-center mx-auto">
        ...
        {/* Safety Badge */}
        <div className="absolute top-[35%] right-[10%] bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-4 flex items-center gap-3 shadow-2xl animate-fade-in-up delay-100 hidden md:flex">
        ...
        {/* Activity Badge */}
         <div className="absolute top-[40%] left-[10%] bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl py-3 px-5 flex items-center gap-3 shadow-2xl animate-fade-in-up delay-200 hidden md:flex">
